  ...
  return (
    ...
    >
      <ul className='tab-btns'>
        <li onClick={() => {setNum(1)}} className={num === 1 ? "active" : ""}>1</li>
        <li onClick={() => {setNum(2)}} className={num === 2 ? "active" : ""}>2</li>
        <li onClick={() => {setNum(3)}} className={num === 3 ? "active" : ""}>3</li>
        <li onClick={() => {setNum(4)}} className={num === 4 ? "active" : ""}>4</li>
      </ul>
...
<ul className='tab-btns'>
        {
          ...
          <li onClick={() => {setNum(index + 1)}} className={num === index + 1 ? "active" : ""}>
            {btn}
          </li>)
        }
      </ul>
